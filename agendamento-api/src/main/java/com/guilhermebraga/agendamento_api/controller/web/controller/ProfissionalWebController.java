...
public class ProfissionalWebController {
    ...
    /**
     * GET /web/profissionais — Exibe a listagem de profissionais.
     */
    @GetMapping
    ...
    /**
     * POST /web/profissionais — Processa o cadastro.
     */
    @PostMapping
    ...
    /**
     * GET /web/profissionais/{id}/editar — Exibe formulário preenchido.
     */
    ...
    /**
     * POST /web/profissionais/{id}/editar — Processa a edição.
     */
